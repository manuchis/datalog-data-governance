...
**Description:** It is a list of objects that describes each status and its timestamp of the negotiation process **for each of the datasets**.  
...
### status
**Description:** The status of the dataset corresponding to the event. Additional statuses can be created, such as "UserNotified", "TimeOut", etc.
