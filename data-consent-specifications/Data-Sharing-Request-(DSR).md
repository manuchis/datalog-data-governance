...
**Description:** Url linking to the formal assessment to determine whether a data processing activity is safe, proportionate, and respectful of privacy, and to identify the measures that should be applied. **optional**
