...
**Description**:  NGSI entity type, in this case "GasConsumption".

| @type         | Expected Type        | Example value(s)     |
| ------------- | -------------        | -------------        |
| https://smartdatamodels.org/dataModel.Consumption/ConsumptionCost   | String       | GasConsumption|
...
**Description**: Code refer to the pressure range. Based on https://tramitesanonimos.cnmc.gob.es/tabla/GAS_RANGO_PRESION

| @type         | Expected Type        | Example value(s)     |
| ------------- | -------------        | -------------        |
| https://schema.org/Text  | String | "03"  |
...
| @type         | Expected Type        | Example value(s)     |
| ------------- | -------------        | -------------        |
| https://schema.org/Text  | String | "Gas consumption record for September 2025"   
